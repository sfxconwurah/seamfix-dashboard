...
**Executive targets (hardcoded in the generator):** Net Profit Margin `NET_MARGIN_TARGET = 10` %, Gross Profit Margin `GROSS_MARGIN_TARGET = 70` %, and `WACC_PCT = 20` % (cost-of-capital assumption for EVA — see below).
